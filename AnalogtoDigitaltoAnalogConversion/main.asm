...
; ---------------- loop sequence -----------------
	loop:													; ADD THE FOLLOWING FUNCTIONALITY HERE:
				ldi			workhorse, 0b11100111		;	use workhorse to store values into ADCSRA by:
	...
	; -------------- output values --------------												; ADD THE FOLLOWING FUNCTIONALITY HERE:
				...
				lds			adc_value_high, ADCH		;		[1] ADCL into adc_value_low
														;		[2] ADCH into adc_value_high
														; 	output the values to their respective ports
	;	---------------Scaler--------------
